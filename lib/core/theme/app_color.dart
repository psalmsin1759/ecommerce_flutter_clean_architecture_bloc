...
class AppColor {
  static const Color primary = Color.fromARGB(255, 34, 82, 227);
  ...
  static const Color secondaryLight = Color(0xFF7BC1B7);
  static const Color secondaryDark = Color(0xFF7BC1B7);
}
